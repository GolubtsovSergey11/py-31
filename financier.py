...
print(name + ',', 'на ипотеку вы потратили за год ', int(mortgage_age), 'рублей')
annual_expenses = annual_salari / 100 * percentage_on_life
annual_prize = prize * monthly_salary
accumulation = (annual_prize / 2) + (annual_salari - (annual_expenses + mortgage_age))
print(name + ',', 'Ваши  накопления за год ', int(accumulation), 'рублей')
